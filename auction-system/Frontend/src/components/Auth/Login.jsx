      ...
      if (data.success) {
        ...
        switch (role) {
          ...
          case 'seller':
            ...
            break
          case 'bidder':
            window.location.href = '/bidder'   // Bidder dashboard
            break
          default:
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 relative">
        ...
        <div className="mb-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 hover:border-gray-400 text-gray-700 font-medium py-3 px-4 rounded-lg transition"
          >
