            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <div className="text-xs text-yellow-600">⭐ Điểm đánh giá: {product.seller_rating || "Chưa có"}</div>
                </div>
                {product.highest_bidder_name && (
                  <div className="pt-3 border-t">
                    ...
                    <div className="text-xs text-yellow-600">⭐ Điểm đánh giá: {product.highest_bidder_rating || "Chưa có"}</div>
                  </div>
                )}
              </div>
            </div>
